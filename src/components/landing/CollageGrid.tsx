    ...
    <section className="w-full flex flex-col gap-10 justify-center items-center">
        ...
        <div className="grid grid-rows-10 grid-cols-4 w-[80%] h-[600px] gap-2">
            ...
            <div className={`row-span-4 col-span-4  rounded-md flex justify-center items-end relative
              shadow-inner ${styles.radialgradient} border border-slate-700/50`}>
              <Image 
                src="/img/bird-2.png" 
                width={150}
                height={150} 
            ...
            <div className={`col-span-2 row-span-3 ${styles.fourthGrid} rounded-md border border-slate-700/50`}>
              <Image 
                  src="/img/pipe.png" 
                  width={150}
                  height={150} 
            ...
            <div className={`col-span-2 row-span-3 ${styles.fifthGrid} rounded-md border border-slate-700/50`}>
